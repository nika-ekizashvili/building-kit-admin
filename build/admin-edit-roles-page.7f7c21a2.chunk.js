(self.webpackChunkmy_project=self.webpackChunkmy_project||[]).push([[2544],{23341:(w,F,r)=>{"use strict";r.r(F),r.d(F,{CreatePage:()=>Ce,default:()=>Oe});var e=r(67294),C=r(66115),o=r(64289),x=r(185),k=r(53979),R=r(11047),E=r(29728),S=r(49066),P=r(41580),M=r(75515),A=r(11276),I=r(74571),y=r(16364),u=r(64256),N=r(67109),Q=r(41054),z=r(27361),he=r.n(z),T=r(41609),X=r.n(T),me=r(86896),h=r(16550),q=r(46449),Y=r(18280),ee=r(48474),ie=r(87751),le=r(87561);const ye=le.Ry().shape({name:le.Z_().required(o.I0.required),description:le.Z_().required(o.I0.required)}),ce=q.ZP.div`
